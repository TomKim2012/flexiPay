...
import static com.workpoint.mwallet.client.ui.users.UserPresenter.GROUPSLOT;
import static com.workpoint.mwallet.client.ui.users.UserPresenter.ITEMSLOT;
...
public class UserView extends ViewImpl implements UserPresenter.MyView {
	...
	@UiField
	HTMLPanel divCategoriesContent;
	...
	public UserView(final Binder binder) {
		...
		divCategoriesContent.getElement().setId("categories");
