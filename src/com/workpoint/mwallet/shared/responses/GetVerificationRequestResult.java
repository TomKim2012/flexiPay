...
public class GetVerificationRequestResult extends BaseResponse {
	...
	private GetVerificationRequestResult() {
		// For serialization only
		transactions = new ArrayList<TransactionDTO>();
		
	}

	public GetVerificationRequestResult(List<TransactionDTO> transactions) {
