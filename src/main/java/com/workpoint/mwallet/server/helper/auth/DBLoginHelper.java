...
public class DBLoginHelper implements LoginIntf {
	...
	public UserDTO createUser(UserDTO UserDTO) {
		...
		if (UserDTO.getPassword() != null) {
			// Passwords are never read from the db to the FE due to one way
			// encryption
	...
	public List<UserDTO> getUsers(String userId, boolean isLoadGroups, boolean isSuperUser, boolean isAdmin,
			Long categoryId) {

		UserGroupDaoImpl dao = DB.getUserGroupDao();
		List<User> users = dao.getAllUsers(userId, isSuperUser, isAdmin, categoryId);
