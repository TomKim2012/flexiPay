...
public class TransactionDao extends BaseDaoImpl {
	 ...
	 */
	public int getMerchantCount(SearchFilter filter, String userId,
	 ...
	 */
	public int getCustomerCount(SearchFilter filter, String userId,
			boolean isSU, boolean isCategoryAdmin, Long categoryId) {
	...
	public List<TransactionDTO> getAll(SearchFilter filter, String userId,
			boolean isSU, boolean isCategoryAdmin, Long categoryId,
			boolean isMerchant) {
		if (filter == null) {
		...
		for (Object[] row : rows) {
			...
			String mpesaSender = (value = row[i++]) == null ? null : value
					.toString();
			String mpesa_msisdn = (value = row[i++]) == null ? null : value
					.toString();
			Double mpesa_amt = (value = row[i++]) == null ? null : new Double(
					value.toString());
			String mpesa_code = (value = row[i++]) == null ? null : value
					.toString();
			...
			String mpesa_acc = (value = row[i++]) == null ? null : value
					.toString();
			boolean isprocessed = (value = row[i++]) == null ? null
					: (Boolean) value;
			...
			String businessName = (value = row[i++]) == null ? null : value
					.toString();
			String smsStatus = (value = row[i++]) == null ? null : value
					.toString();
